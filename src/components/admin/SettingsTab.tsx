  ...
  return (
    <div className="space-y-4 mt-3">
      ...
      <div className="space-y-2">
        ...
        <label className="flex items-center gap-2 cursor-pointer bg-muted/50 border rounded-md px-3 py-2 text-sm text-muted-foreground hover:text-foreground hover:border-primary/50 transition-all">
      ...
      <div className="border-t border-border/30 pt-4 mt-4">
        ...
        <div className="space-y-3">
          {[
            ...
            { key: "show_sold_out" as const, label: "Show Sold Out Items" },
            { key: "show_search" as const, label: "Enable Menu Search" },
